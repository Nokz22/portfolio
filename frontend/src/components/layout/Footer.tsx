  ...
  return (
    <footer className="bg-ink-950 text-white py-12">
      <div className="max-w-content mx-auto px-6 flex flex-col items-center gap-6">
        <span className="font-display font-bold text-accent text-xl">Nuno Ferreira</span>
        ...
        <p className="text-ink-400 text-body-sm text-center">
          © {year} Nuno Ferreira. {t('footer.rights')}.
        </p>
      </div>
    </footer>
  )
